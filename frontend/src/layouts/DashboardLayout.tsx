...
import { LayoutDashboard, Search, Briefcase, Settings, Bot, FileText, BarChart3 } from 'lucide-react';
...
export default function DashboardLayout() {
  ...
  const navItems = [
    ...
    { name: 'Documents', path: '/dashboard/documents', icon: FileText, exact: false },
    { name: 'Analytics', path: '/dashboard/analytics', icon: BarChart3, exact: false },
